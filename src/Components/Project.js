...
const projects = [
  {
    ...
    description: (
      <>
        <ul className="list-disc pl-5 text-sm text-gray-700 text-left space-y-2">
          <li>
            <strong className="text-blue-600">User Authentication</strong>: Secure with <span className="text-green-600">JWT</span> and <span className="text-purple-600">bcryptjs</span>.
          </li>
          <li>
            <strong className="text-orange-500">Twilio Integration</strong>: Sends quiz results via <span className="text-red-600">WhatsApp API</span>.
          </li>
          <li>
            <strong className="text-teal-600">Responsive Design</strong>: Optimized for all screen sizes.
          </li>
        </ul>
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        <p className="text-xs text-green-600 mb-2 text-center">🚧 Currently in development. Stay tuned for updates!</p>
        <ul className="list-disc pl-5 text-sm text-gray-700 text-left space-y-2">
          <li><strong className="text-blue-600">🏷️ Product Listings</strong>: Dynamic filtering with categories.</li>
          <li><strong className="text-green-600">🛍️ Cart & Checkout</strong>: Smooth add-to-cart and checkout flow.</li>
          <li><strong className="text-purple-600">💳 Payment Integration</strong>: Multi-gateway support.</li>
          <li><strong className="text-red-600">📱 Responsive Design</strong>: Optimized for all devices.</li>
        </ul>
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        <ul className="list-disc pl-5 text-sm text-gray-700 text-left space-y-2">
          <li><strong className="text-teal-600">Responsive Design</strong>: Works on desktop and mobile.</li>
          <li><strong className="text-blue-600">🎭 Meme Explorer</strong>: Browse memes with infinite scroll.</li>
          <li><strong className="text-green-600">🖼️ Meme Upload</strong>: Upload images/GIFs and generate AI captions.</li>
          <li><strong className="text-purple-600">❤️ Like & Comment</strong>: User engagement features.</li>
        </ul>
      </>
    ),
...
const Project = () => {
  return (
    <section id="projects" className="bg-gray-100 py-12 min-h-screen">
            ...
            >
              ...
              <div className="p-5 flex flex-col justify-between flex-grow">
                <div>
                  ...
                  <div className="project-description max-h-44 overflow-y-auto pr-2">
                    {project.description}
                  </div>
                </div>
                <div className="flex justify-between mt-4">
                  <motion.a
                    ...
                    className="flex items-center gap-2 text-white bg-gray-800 px-4 py-2 rounded-lg hover:bg-gray-700 transition"
                  >
                    <FaGithub /> GitHub
                  </motion.a>
                  <motion.a
                    ...
                    rel="noopener noreferrer"
                    whileHover={{ scale: 1.05 }}
                    className="flex items-center gap-2 text-white bg-green-600 px-4 py-2 rounded-lg hover:bg-green-500 transition"
                  >
